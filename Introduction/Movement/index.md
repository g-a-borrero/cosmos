...
In order to determine a character's movements, we have to know some things about them. Namely, their origin Heavenly Body, their current [Heavenly Body](cosmos/Factors/HeavenlyBody]) their origin [Atmosphere](cosmos/Factors/Atmosphere).
